...
const username = process.env.PLAYWRIGHT_USERNAME ?? process.env.DEFINITION_IMPORTER_USERNAME;
const password = process.env.PLAYWRIGHT_PASSWORD ?? process.env.DEFINITION_IMPORTER_PASSWORD;
